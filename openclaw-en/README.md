...
Most people use AI as a smarter search engine — ask a question, get an answer. OpenClaw is different. Give it a skill, and it doesn't just respond — it acts. It reads your HA devices, creates automations, adjusts settings. You tell it what you want, it handles the rest.

You can even do this remotely. Away from home, on your phone — open a chat, describe what you need, and OpenClaw takes care of it. No terminal. No remote desktop. Just a conversation.

This add-on includes a curated set of built-in skills so the most common things — connecting to HA, setting up AI channels, adjusting gateway settings — are all one conversation away.
